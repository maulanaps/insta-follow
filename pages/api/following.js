...
const fetchFollowing = async ({count, startId}) => {
    ...
    const { data } = await axios.get(`https://www.instagram.com/api/v1/friendships/745679711/following/?count=${count}&max_id=${startId}`, axiosConfig)
...
export default async function handler(req, res) {
    ...
    console.log(query);
    const data = await fetchFollowing(query)
